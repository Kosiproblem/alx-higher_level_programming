...
class Rectangle:
    ...
    def square(cls, size=0):
        """Returns new Rectangle instance of equal width and height
        Args:
            cls (class): Refers to the class Rectangle
            size (int, optional): Size of the square
        Returns:
            New Rectangle instance with equal width and height
        """
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Determines the biggest rectangle from the area value
        Args:
            rect_1 (Rectangle object): Instance of Rectangle class
            rect_2 (Rectangle object): Instance of Rectangle class
        Returns:
            biggest Rectangle object
        """
